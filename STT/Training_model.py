...
train_audio_path = './STT/input/audio/'
duration = 1.5
all_wave = []
all_label = []
for label in labels:
...
mc = ModelCheckpoint('./STT/best_model.hdf5', monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
